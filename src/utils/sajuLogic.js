...
export const getCurrentLuckInterpretation = (sajuData, userInfo, targetYear) => {
  ...
  const yeonhaeLuck = {
    '비견': { daewun: '연해자평에서는 비견 대운을 \"스스로의 힘으로 세상에 홀로 서는 시기\"로 봅니다. 독립심이 극에 달하며, 형제나 동료와의 관계에서 갈등과 협력이 교차합니다. 자신만의 영역을 확보하면 대성의 기회가 열립니다.', sewun: '연해자평에서 비견 세운은 \"내 것을 지키려는 마음이 강해지는 해\"입니다. 재물의 분배나 공유에서 갈등이 있을 수 있으며, 자기 주장을 명확히 하되 독선은 삼가야 합니다.', wolun: '연해자평 관점에서 자기 확신이 높아지는 달입니다. 독자적 판단으로 행동하되 주변과의 소통을 잊지 마십시오.' },
    '겁재': { daewun: '연해자평에서 겁재 대운은 \"투쟁과 쟁취의 기운이 최고조에 달하는 시기\"입니다. 남에게 지기 싫어하는 승부사 기질이 성공의 원동력이 되며, 위기에 처했을 때 더욱 강해집니다.', sewun: '연해자평에서 겁재 세운은 \"재물이 오고 가는 변동이 큰 해\"입니다. 도박이나 투기성 투자는 절대 금하고, 확실한 기회만 잡으면 큰 이득을 볼 수 있습니다.', wolun: '연해자평 관점에서 경쟁이 심해지는 달입니다. 지출 관리를 철저히 하고 충동적 결정을 삼가야 합니다.' },
    '식신': { daewun: '연해자평에서 식신 대운은 \"의식주 걱정 없이 풍요를 누리는 낙천의 시기\"입니다. 미식가적 기질이 발현되고 예술·창작 활동이 활발해지며, 자녀와 관련된 경사가 따릅니다.', sewun: '연해자평에서 식신 세운은 \"타고난 재능을 세상에 펼치는 해\"입니다. 성품이 원만해져 적을 만들지 않으며, 먹고 마시는 즐거움과 함께 삶의 질이 높아집니다.', wolun: '연해자평 관점에서 풍족하고 여유로운 달입니다. 맛집 탐방이나 문화생활을 즐기기에 좋습니다.' },
    '상관': { daewun: '연해자평에서 상관 대운은 \"총명함이 세상에 드러나 문장과 기술로 이름을 떨치는 시기\"입니다. 언변이 화려하고 임기응변에 능하며, 기존 체제에 대한 불만이 혁신의 에너지로 전환됩니다.', sewun: '연해자평에서 상관 세운은 \"입이 칼보다 날카로워지는 해\"입니다. 냉소적 언행이 늘 수 있으나 자신의 재능을 인정받으면 최고의 성과를 냅니다. 구설에 각별히 조심해야 합니다.', wolun: '연해자평 관점에서 재능이 빛나되 말조심이 필요한 달입니다. 창의적 프로젝트에 집중하면 좋은 성과가 있습니다.' },
    '편재': { daewun: '연해자평에서 편재 대운은 \"천하의 재물을 논하며 호탕하게 사업을 벌이는 시기\"입니다. 고향을 떠나 타지나 해외에서 기회를 잡으며, 대인관계에서 큰 손으로 통합니다.', sewun: '연해자평에서 편재 세운은 \"예상치 못한 재물의 기회가 오는 해\"입니다. 새로운 사업이나 모험에 과감히 도전하면 큰 성과를 거둘 수 있습니다. 이성과의 인연도 활발합니다.', wolun: '연해자평 관점에서 새로운 재물 기회가 열리는 달입니다. 활동적으로 움직이고 인맥을 넓히면 길합니다.' },
    '정재': { daewun: '연해자평에서 정재 대운은 \"성실과 신용의 화신으로서 정당한 노력의 대가를 받는 시기\"입니다. 절약 정신이 투철하여 티끌 모아 태산을 이루는 끈기가 빛을 발합니다.', sewun: '연해자평에서 정재 세운은 \"약속을 지키는 자에게 신뢰가 따르는 해\"입니다. 가정의 화목과 안정적인 수입이 보장되며, 무리한 욕심보다 착실한 실속이 중요합니다.', wolun: '연해자평 관점에서 안정과 실속의 달입니다. 저축이나 안정적 투자에 유리하며 가정이 평안합니다.' },
    '편관': { daewun: '연해자평에서 편관 대운은 \"칠살이 칼을 차고 있으니 다스리면 영웅이요, 다스리지 못하면 화근\"이라고 합니다. 큰 어려움을 겪을수록 그 이름값이 높아지며, 의리와 정의감이 빛납니다.', sewun: '연해자평에서 편관 세운은 \"시련과 압박 속에서 진가가 드러나는 해\"입니다. 불의를 보면 참지 못하는 협객의 기질이 발현되며, 인내하면 반드시 보상이 따릅니다.', wolun: '연해자평 관점에서 의지력이 시험받는 달입니다. 인내하고 정면 돌파하면 큰 성취가 뒤따릅니다.' },
    '정관': { daewun: '연해자평에서 정관 대운은 \"단정한 선비가 대궐에 서듯 품격 있는 지위를 얻는 시기\"입니다. 원칙을 지키는 정직함이 최고의 자산이 되며, 자손까지 번창하게 합니다.', sewun: '연해자평에서 정관 세운은 \"공식적인 지위와 명예가 빛나는 해\"입니다. 누구에게나 신뢰를 주는 성품 덕분에 큰 다툼 없이 순탄하게 부귀를 누립니다.', wolun: '연해자평 관점에서 명예와 품격이 높아지는 달입니다. 공식적인 자리에서 인정받는 기회가 옵니다.' },
    '편인': { daewun: '연해자평에서 편인 대운은 \"한 가지 재주로 세상을 놀라게 하는 시기\"입니다. 남들이 보지 못하는 기회를 포착하는 직관력이 일품이며, 종교·철학·예술 분야에서 깊은 경지에 도달합니다.', sewun: '연해자평에서 편인 세운은 \"고독 속에서 영감을 얻는 해\"입니다. 사색과 연구에 몰두하면 남들이 따라올 수 없는 독창적 성과를 거둡니다.', wolun: '연해자평 관점에서 영감과 직관이 빛나는 달입니다. 혼자만의 시간을 통해 깊은 통찰을 얻을 수 있습니다.' },
    '정인': { daewun: '연해자평에서 정인 대운은 \"평생 학문에 힘쓰고 귀인의 도움이 끊이지 않는 복운\"입니다. 문서운이 강력하여 부동산이나 저술 활동에서 큰 성과를 거두며, 정신적 지도자로서 존경받습니다.', sewun: '연해자평에서 정인 세운은 \"배움과 가르침이 동시에 빛나는 해\"입니다. 자격증 취득, 학업 성취, 부동산 계약 등 문서와 관련된 모든 일에 대길합니다.', wolun: '연해자평 관점에서 학습과 성장의 달입니다. 새로운 지식을 습득하거나 자격증에 도전하기 좋습니다.' }
  };
